...
header = """
  ------------------
< \033[1;36mAristo Installer!!\033[1;36m >
  ------------------
         \   ^__^
          \  (oo)\_______
             (__)\       )\/\
...
if option == "1":
    ...
    install2 = os.system("cp -R aristo/ /opt/ && cp aristo.py /opt/aristo && cp run.sh /opt/aristo && cp run.sh /usr/bin/aristo && chmod +x /usr/bin/aristo")
